      ...
      <div className="absolute min-w-full w-max top-[calc(100%+.5rem)] right-0 shadow">
        <Collapse show={isShow} setShow={setIsShow}>
          <div className="bg-white rounded py-2 border">
            <div className="flex items-center space-x-2 hover:bg-blue-200 px-4 py-2">
              <span className="icon">
            ...
            <div className="flex items-center space-x-2 hover:bg-blue-200 px-4 py-2 text-red-500">
              <span className="icon">
