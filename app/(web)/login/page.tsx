    ...
    <Container className="py-8">
      ...
      >
        ...
        <div className="mt-6 flex flex-col space-y-4">
          <input type="email" className="w-full form-input rounded" name='email' placeholder='Tài khoản' />
          <input type="password" className="w-full form-input rounded" name='password' placeholder='Mật khẩu' />
          ...
          <button className='w-full rounded-full px-4 py-1.5 bg-blue-500 text-white'>Đăng nhập</button>

          <div className="flex items-center space-x-3 justify-center">
            <span className="icon w-10 h-10 rounded-full border-2 p-2 border-rose-500 bg-white text-rose-500 hover:bg-rose-500 hover:text-white cursor-pointer">
            ...
            <span className="icon w-10 h-10 rounded-full border-2 p-2 border-blue-500 bg-white text-blue-500 hover:bg-blue-500 hover:text-white cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z"></path></svg>
            </span>
            <span className="icon w-10 h-10 rounded-full border-2 p-2 border-slate-500 bg-white text-slate-500 hover:bg-slate-500 hover:text-white cursor-pointer">
